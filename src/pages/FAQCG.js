...
const FAQCG = () => {
    ...
    return (
        <div className="bg-white min-h-screen">
            <SEO
                title="FAQ - Corner & Wall Guards by Elastomech"
                description="Explore Elastomech's detailed FAQ on corner and wall guards. Learn about rubber, polyurethane, and metal guards for industrial, commercial, and residential applications. Get expert insights on selection, installation, safety, and maintenance."
                keywords="corner guards, wall guards, rubber corner guards, polyurethane wall guards, industrial corner guards, commercial wall guards, protective guards, safety guards, impact-resistant guards, durable corner guards, wall protection, corner protection, OSHA-compliant guards, heavy-duty guards, custom guards, Elastomech guards, best corner guards, buy wall guards, corner guard installation, wall guard maintenance"
            />
            <NavBar />
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mt-6 text-center">
                    <Link to="/" className="text-blue-500 font-semibold">Back to Home</Link>
                </div>
            </div>
            <Footer />
        </div>
